...
function catagorize(id) {
    // var input = document.getElementById("searchbar");
   const SearchResult = await getProductDetailid(id);
    ...
    const getProductDetailid = async (name) => {
        // var text = name.target.value;
        // console.log(text);
        var searchresult = null;
        await axios.get(`http://127.0.0.1:8000/store/products/?collection_id=${name}`)
            .then(async res => {
